...
This command creates NGS13x_pileup.csv files in 'result' directories for all NGS runs in /data/sewer/ that not contain pileup file. Afterwards the pipeline will create 'result_NGS130-134' directory with Monitored_Mutations_20220112.csv table for all samples in NGS130, NGS131, NGS132, NGS133 and NGS134.
